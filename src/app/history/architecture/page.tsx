...
// Upgraded as the main "Buildings & Architecture" hub:
// - Adds a visible "Key buildings at a glance" grid using HIGHLIGHTS.
// - Keeps existing SEO, JSON-LD and section structure intact.
      ...
      <div className="container mx-auto grid max-w-7xl items-start gap-8 px-4 py-10 md:grid-cols-2 md:py-14">
        <div>
          ...
          <p className="mt-4 max-w-prose text-lg text-gray-700">
            How Lockwood &amp; Mawson and Sir Titus Salt created a complete
            model village: Italianate mill forms, a formal street grid, unified
            stone terraces and civic set pieces — with a designed park across
            the river.
          </p>
...
function OnThisPage() {
  const items = [
    ...
    { href: '#highlights', label: 'Key buildings' }, // NEW
  ...
  return (
    ...
    >
      ...
      <div className="prose mt-2 text-gray-700">
        <p>
          Saltaire is a <em>complete</em> mid-19th-century model village planned
          around textile production and social welfare. The architecture is
          unified in material and proportion: local sandstone, disciplined
          fenestration and classical composition, with Italianate palazzo
          language shaping the mills and the grandest civic buildings.
        </p>
        <p>
          The street grid is formal and legible, anchored by{' '}
          <strong>Victoria Road</strong> — aligning mill offices with the{' '}
          <Link
          ...
          , institute and other set pieces — and by the relationship with{' '}
          <Link
            className="underline underline-offset-4"
            href="/roberts-park"
          >
          ...
          across the river. Together they create a landscape of work, welfare
          and recreation that remains remarkably intact.
        </p>
      </div>
    </section>
  )
...
/**
 * NEW: visible grid using HIGHLIGHTS.
 * This turns the architecture page into a true "buildings hub".
 */
  ...
  return (
    ...
    >
      ...
      <p className="mt-2 max-w-prose text-gray-700">
        These are the core buildings that define Saltaire’s look and feel. Each
        card links to a deeper guide, mixing history with practical visiting
        tips.
      </p>
      <div className="mt-4 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {HIGHLIGHTS.map((h) => (
          ...
          >
            ...
            <p className="mt-1 text-sm text-gray-700">{h.summary}</p>
    ...
    >
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div className="prose text-gray-700">
          <p>
            The village is arranged on a rectilinear grid with a clear
            hierarchy: Victoria Road as ceremonial axis; regular cross-streets;
            and short vistas to civic buildings or mill masses. This order
            delivers easy wayfinding and a calm streetscape.
          </p>
          <ul className="mt-2 list-disc pl-5">
            <li>
              <strong>Victoria Road axis:</strong> from mill offices to church
              and civic cluster.
            </li>
            <li>
              <strong>Mill ensemble:</strong> long façades articulated in bays
              with towers and stair-turrets marking corners and fire-breaks.
            </li>
            <li>
              <strong>Park connection:</strong> bridge and footpaths align views
              to the bandstand and river lawns, balancing the density of the
              mill with open landscape.
            </li>
          </ul>
        </div>
      ...
      <p className="mt-2 text-xs text-gray-500">
        Illustrative view — consult official mapping for boundaries and
        listings.
      </p>
    </section>
  )
        ...
        <div className="card card-muted">
          <div className="card-body">
            ...
            <p className="mt-2 text-gray-700">
              Look for the bay rhythm set by window spacing; string courses and
              cornice lines unify blocks; door surrounds vary subtly by status.
              Cast-iron rainwater goods, stone boundary walls and simple
              railings complete the streetscape.
            </p>
          </div>
        </div>
      </div>
...
function Typologies() {
  return (
    ...
    >
      ...
      <p className="mt-2 max-w-prose text-gray-700">
        Workers’ housing is deliberately regular and healthy by the standards of
        the day, with stepped status cues in plot width, siting and detail.
        Higher-status dwellings face key routes or corners; standard terraces
        fill the grid.
      </p>
...
function CivicSetPieces() {
  ...
  return (
    ...
    >
      ...
      <p className="mt-2 max-w-prose text-gray-700">
        Public buildings articulate the moral and social ambitions of the
        village: worship, learning, care and recreation are expressed with
        confident classical language and high-quality craft.
      </p>
...
function Trail() {
  ...
  return (
    ...
    >
      ...
      <p className="mt-2 max-w-prose text-gray-700">
        A short loop that reveals the planning and architectural language. Start
        at the mill offices and follow Victoria Road to the church and civic
        cluster, then cross to the park.
      </p>
  ...
  return (
    ...
    >
      ...
      <p className="mt-3 text-sm text-gray-600">
        Many works require consent. Always check with the Council’s conservation
        team and read the Conservation Area guidance. See our{' '}
...
function Glossary() {
  const terms = [
    {
      term: 'Ashlar',
      def: 'Finely dressed stone laid in regular courses for crisp façades.',
    },
    {
      term: 'String course',
      def: 'A horizontal band of masonry used to unify or articulate elevations.',
    },
    {
      term: 'Fenestration',
      def: 'The arrangement and proportion of windows on a façade.',
    },
    {
      term: 'Palazzo form',
      def: 'Italianate composition recalling Renaissance urban palaces.',
    },
    {
      term: 'Lime mortar',
      def: 'Breathable, flexible mortar suited to historic masonry.',
    },
  ]
  return (
    <section
...
function Sources() {
  const items = [
    ...
    },
    {
      ...
      href:
        'https://www.bradford.gov.uk/environment/saltaire/saltaire-world-heritage-site-information-and-history/',
  ...
  const breadcrumbs = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 3,
        name: 'Architecture',
        item: `${base}/history/architecture`,
      },
    ],
  }
...
export default function ArchitecturePage() {
  return (
    <>
      ...
      <OnThisPage />
      <Overview />
      <HighlightsGrid /> {/* new hub grid using HIGHLIGHTS */}
      <PlanAxes />
      <MaterialsDetails />
      <Typologies />
      <CivicSetPieces />
