...
const ERA_PRE: TL[] = [
  {
    ...
    links: [
      ...
      {
        label: "Wikipedia — Titus Salt",
        href: "https://en.wikipedia.org/wiki/Titus_Salt",
  ...
  },
  {
    ...
    links: [
      {
        label: "Local studies note",
        href: "https://bradfordlocalstudies.com/titus-salt/",
      }, // :contentReference[oaicite:1]{index=1}
      {
        label: "List of Bradford mayors",
        href: "https://en.wikipedia.org/wiki/List_of_mayors_of_Bradford",
...
const ERA_SALT: TL[] = [
  ...
  },
  {
    ...
    links: [
      {
        label: "Saltaire overview",
        href: "https://en.wikipedia.org/wiki/Saltaire",
      }, // :contentReference[oaicite:5]{index=5}
      {
        label: "About Salts Mill",
  ...
  },
  {
    ...
    links: [
      {
        label: "Saltaire Collection note",
        href: "https://www.saltairecollection.org/story-of-saltaire/hopital-and-almshouses/",
      }, // :contentReference[oaicite:8]{index=8}
      {
        label: "Village info — Almshouses",
        href: "https://saltairevillage.info/Saltaire_WHS_Almshouses.html",
      }, // :contentReference[oaicite:9]{index=9}
      {
        label: "Village info — Hospital",
        href: "https://saltairevillage.info/Saltaire_WHS_Hospital.html",
  ...
  },
  {
    ...
    links: [
      {
        label: "Salt baronetcy (record)",
        href: "https://en.wikipedia.org/wiki/Salt_baronets",
      }, // :contentReference[oaicite:16]{index=16}
      {
        label: "Peerage note",
        href: "https://www.thepeerage.com/p57081.htm",
  ...
  },
  {
    ...
    links: [
      {
        label: "Victoria Hall (about)",
        href: "https://victoriahallsaltaire.co.uk/about",
      }, // :contentReference[oaicite:11]{index=11}
      {
        label: "Wikipedia — Victoria Hall",
  ...
  },
  {
    ...
    links: [
      {
        label: "Roberts Park (Wikipedia)",
        href: "https://en.wikipedia.org/wiki/Roberts_Park,_Saltaire",
      }, // :contentReference[oaicite:13]{index=13}
      {
        label: "Victorian Web — opening day",
        href: "https://victorianweb.org/art/parks/20.html",
      }, // :contentReference[oaicite:14]{index=14}
      {
        label: "Saltaire Collection — park note",
        href: "https://explore.saltairecollection.org/s/p/item/8016?page=5",
  ...
  },
  {
    ...
    links: [
      {
        label: "UNESCO nomination PDF (history excerpt)",
...
const ERA_POSTSALT: TL[] = [
  {
    ...
    links: [
      {
        label: "UNESCO nomination (history)",
        href: "https://whc.unesco.org/document/151571",
      },
  ...
  },
  {
    ...
    links: [
      {
        label: "Village history note",
        href: "https://saltairevillage.info/Saltaire_WHS_After_Titus_Salt.html",
      }, // :contentReference[oaicite:20]{index=20}
      {
        label: "Saltaire Collection — owners & managers",
        href: "https://www.saltairecollection.org/story-of-saltaire/owners-and-managers/",
      }, // :contentReference[oaicite:21]{index=21}
      {
        label: "Wikipedia — Sir James Roberts",
        href: "https://en.wikipedia.org/wiki/Sir_James_Roberts,_1st_Baronet",
  ...
  },
  {
    ...
    links: [
      ...
      {
        label: "Local diary 1920",
        href: "https://saltairevillage.info/Saltaire_diary_1920.html",
...
const ERA_20C: TL[] = [
  ...
  },
  {
    ...
    links: [
      {
        label: "Wikipedia — Sir James Roberts (business timeline)",
        href: "https://en.wikipedia.org/wiki/Sir_James_Roberts,_1st_Baronet",
      },
  ...
  },
  {
    ...
    links: [
      {
        label: "Industrial archaeology blog note",
        href: "https://johndewhirst.blog/2021/01/22/industrial-archaeology/",
      }, // :contentReference[oaicite:29]{index=29}
      {
        label: "Salts Mill — official “About”",
        href: "https://saltsmillshop.co.uk/pages/about-salts-mill",
  ...
  },
  {
    ...
    links: [
      {
        label: "Wikipedia — Jonathan Silver",
        href: "https://en.wikipedia.org/wiki/Jonathan_Silver",
      }, // :contentReference[oaicite:31]{index=31}
      {
        label: "Salts Mill — official page",
        href: "https://saltsmillshop.co.uk/pages/about-salts-mill",
      ...
      <div className="container mx-auto grid max-w-7xl items-start gap-8 px-4 py-10 md:grid-cols-2 md:py-14">
        <div>
          <h1 className="text-3xl font-extrabold tracking-tight md:text-5xl">
            Saltaire history timeline
          </h1>
          <p className="mt-4 max-w-prose text-lg text-gray-700">
            The definitive chronology of Saltaire: from Titus Salt’s early life
            and the founding of the mill and model village to 20th-century
            change, 1980s revival and UNESCO World Heritage status.
          </p>
...
function OnThisPage() {
  const items = [
    ...
    { href: "#after-salt", label: "After Salt (1877–1920)" },
  ...
  return (
    ...
    >
      ...
      <p className="mt-2 max-w-prose text-gray-700">
        We prioritise primary and official sources. For full architectural
        detail, also see Historic England entries and Bradford’s Conservation
        Area guidance.
      </p>
...
export default function TimelinePage() {
  return (
    <>
      ...
      <Era
        id="after-salt"
        title="After Salt: ownership, philanthropy & park renaming (1877–1920)"
