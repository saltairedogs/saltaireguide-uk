// src/app/saltaire/jinnah-bistro/page.tsx
...
/**
 * Jinnah Bistro — business page (vintage “paper on desk” template)
 * - Uses the Saltaire Brewery / Digin’s Hut layout + components
 * - Hero + gallery use your images in /public/images/saltaire/jinnah-bistro/
 * - Right rail focuses on essentials + hours + contact + CLAIM LISTING (WhatsApp)
...
const PATH = "/saltaire/jinnah-bistro";
...
// Images you provided:
// /public/images/saltaire/jinnah-bistro/*
const HERO_IMAGE = "/images/saltaire/jinnah-bistro/outside-view.png";

// Gallery images (exclude hero)
const GALLERY = [
  {
    src: "/images/saltaire/jinnah-bistro/2-plates.png",
    alt: "Plated dishes at Jinnah Bistro in Saltaire",
  },
  {
    src: "/images/saltaire/jinnah-bistro/indoor-view.png",
    alt: "Dining room interior at Jinnah Bistro",
  },
  {
    src: "/images/saltaire/jinnah-bistro/meat-cooking.png",
    alt: "Meat cooking on the grill at Jinnah Bistro",
  },
  {
    src: "/images/saltaire/jinnah-bistro/meat-dish.png",
    alt: "Signature meat dish served at Jinnah Bistro",
  },
] as const;
...
const biz = {
  ...
  tagline: "Restaurant • Evening dining • Saltaire (BD18)",
  shortDesc:
    "A well-known Saltaire restaurant on Bingley Road, built for relaxed evening meals — the kind of place you go when you want a sit-down dinner that feels like a proper occasion without being fussy.",
  longDesc:
    "They promote online ordering and a full menu on their website, with a focus on freshly prepared dishes and a wide range of options. If you’re planning a busy Friday/Saturday, treat it as an “evening booking” type of place and confirm hours before a special trip.",

  categories: ["Restaurant", "Saltaire", "Evenings", "Vegan options"],

  address: "69 Bingley Rd, Saltaire, Bradford BD18 4SB",
  postcode: "BD18 4SB",

  phone: "01274 396666",
  website: "https://jinnahbistrosaltaire.com/",
  facebookUrl: "https://www.facebook.com/JinnahBistro/?locale=en_GB",

  lastVerified: UPDATED,
  heroImage: HERO_IMAGE,
  photos: GALLERY,

  hoursNote: "Hours can change around holidays — double-check on Google or the website before travelling.",
  hours: [
    { day: "Monday", times: "Closed" },
    { day: "Tuesday", times: "4:30–10 pm" },
    { day: "Wednesday", times: "4:30–10 pm" },
    { day: "Thursday", times: "4:30–10 pm" },
    { day: "Friday", times: "4:30–10 pm" },
    { day: "Saturday", times: "4:30–10 pm" },
    { day: "Sunday", times: "4:30–10 pm" },
  ],

  editorial: {
    bestFor: ["Evening dinner in Saltaire", "Groups and family meals", "Dinner + a village walk beforehand"],
    vibe: ["Warm", "Classic restaurant feel", "Reliable local choice"],
    goodToKnow: [
      "Closed Mondays; otherwise it’s typically an evening service.",
      "Vegan dishes are listed as available (confirm on the current menu if you have strict dietary needs).",
      "Weekend evenings can be busy — book ahead if you hate waiting.",
    ],
    bestTime: "Midweek evenings for a calmer meal; Friday/Saturday for more atmosphere.",
    accessibilityNote:
      "If you need step-free access or space for a pram/wheelchair, check the entrance/aisles on arrival (older village frontages can vary).",
  },

  whatToTry: [
    "If you’re undecided: go in with a preference (mild / medium / hot) and choose from the current menu rather than overthinking it.",
    "For groups: pick a spread of different dishes so everyone isn’t locked into one style.",
    "If you’re ordering online: check the collection/delivery details before you commit to timings.",
  ],

  ambience: ["Sit-down dining", "Evening service", "Good for groups", "Saltaire staple"],

  typicalSpend: "£20–30 (as shown on Google listing at time of check)",
} as const;
...
export const metadata: Metadata = {
  title: "Jinnah Bistro — Restaurant in Saltaire | Saltaire Guide",
  description:
    "Jinnah Bistro in Saltaire (BD18 4SB): address, opening hours, website, and reviews. A popular evening restaurant on Bingley Road.",
  alternates: { canonical: `${site.url}${PATH}` },
  openGraph: {
    title: "Jinnah Bistro — Restaurant in Saltaire | Saltaire Guide",
    description: "Jinnah Bistro on Bingley Road, Saltaire. Address, typical opening hours, and practical visit info.",
    url: `${site.url}${PATH}`,
    type: "article",
    images: [
      {
        ...
        width: 1600,
        height: 1200,
        alt: "Jinnah Bistro exterior on Bingley Road, Saltaire",
      },
    ],
  },
  twitter: {
...
const FAQS = [
  {
    q: "Where is Jinnah Bistro in Saltaire?",
    a: "Jinnah Bistro is at 69 Bingley Road, Saltaire, Bradford BD18 4SB — on the main road through the village.",
  },
  {
    q: "What are Jinnah Bistro’s opening hours?",
    a: "Typical hours are Tuesday–Sunday 4:30–10 pm, and closed on Mondays. Hours can change around holidays, so confirm before a special trip.",
  },
  {
    q: "Does Jinnah Bistro have vegan options?",
    a: "Vegan dishes are listed as available. If you have strict dietary requirements, check the current menu or contact the restaurant before you visit.",
  },
  {
    q: "Can I order online?",
    a: "They promote online ordering via their website. Check the website for the latest menu and ordering options.",
  },
] as const;
...
const CLAIM_BENEFITS = [
  ...
  "Add menu/booking links + more photos.",
...
function buildLd() {
  ...
  const webpage = {
    ...
    "@type": "WebPage",
    name: "Jinnah Bistro — Restaurant in Saltaire | Saltaire Guide",
    url: `${base}${PATH}`,
  ...
  const breadcrumbs = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Saltaire", item: `${base}/saltaire` },
      { "@type": "ListItem", position: 3, name: "Jinnah Bistro", item: `${base}${PATH}` },
    ],
  };
  ...
  const restaurant = {
    ...
    address: {
      "@type": "PostalAddress",
      streetAddress: "69 Bingley Rd",
      addressLocality: "Saltaire",
      addressRegion: "West Yorkshire",
      postalCode: "BD18 4SB",
      addressCountry: "GB",
    },
    sameAs: [biz.website, biz.facebookUrl].filter(Boolean),
    url: `${base}${PATH}`,
                ...
                <Card className="p-0">
                  <div className="p-5">
                    ...
                    <div className="mt-4 rounded-xl border border-stone-200 bg-[#fbf7f1] p-3 text-[12px] text-stone-700">
                      Quick rule: it’s mainly evenings — don’t assume lunch service.
                    </div>
                  </div>
                </Card>
                  ...
                  <div className="p-5">
                    ...
                    <div className="mt-4 space-y-3">
                      <div className="rounded-xl border border-stone-200 bg-white p-3">
                        <div className="text-[12px] font-semibold text-[#0f3d2e]">Location</div>
                        <div className="mt-1 text-[13px] leading-relaxed text-stone-800">
                          On Bingley Road — easy to pair with a Saltaire village wander.
                        </div>
                      </div>
                      ...
                      <div className="rounded-xl border border-stone-200 bg-white p-3">
                        ...
                        <div className="mt-1 text-[13px] leading-relaxed text-stone-800">
                          Phone:{" "}
                          <a className="underline" href={`tel:${cleanTel(biz.phone)}`}>
                            {biz.phone}
                          </a>
                        </div>
                        <div className="mt-1 text-[13px] leading-relaxed text-stone-800">
                          Website:{" "}
                          <a className="underline" href={biz.website} target="_blank" rel="noopener noreferrer">
            ...
            <div className="space-y-4 md:col-span-1">
                ...
                <div className="p-5">
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <span className="inline-flex items-center rounded-full border border-stone-200 bg-[#fbf7f1] px-2.5 py-1 text-[11px] font-medium text-stone-700">
                      ££ <span className="ml-1 text-stone-500">mid-range</span>
                    </span>
                  </div>
                      ...
                      {!biz.claimed ? (
                        <div className="mt-4 rounded-xl border border-stone-200 bg-[#fbf7f1] p-3">
                          ...
                          <div className="mt-1 text-[12px] leading-relaxed text-stone-700">
                            Owners/managers can claim this page to keep details accurate. Proof required to mark as
                            claimed.
                          </div>
                          ...
                          <div className="mt-3">
                            ...
                            <div className="mt-2 text-[11px] text-stone-600">
                              Proof accepted: reply from a domain email or a screenshot of Google Business Profile
                              access.
                            </div>
                          </div>
                        </div>
              ...
              <Card className="p-0">
                <div className="p-4">
                  ...
                  <p className="mt-1 text-[12px] text-stone-700">Useful pages if you’re planning a day around Saltaire.</p>
                  <div className="mt-3 flex flex-col gap-2">
                    <Link
                      href="/saltaire"
