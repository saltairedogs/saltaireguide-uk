// src/app/saltaire/boathouse-inn/page.tsx
...
/**
 * The Boathouse Inn — business page (vintage “paper on desk” template)
 * - Uses the Saltaire Brewery / Digin’s Hut layout + components
 * - Hero + gallery use your images in /public/images/saltaire/boathouse/
 * - Right rail focuses on essentials + hours + contact + CLAIM LISTING (WhatsApp)
 * - Reviews section: FULL-WIDTH (shared ReviewsSection)
 * - Structured data: WebPage + BreadcrumbList + BarOrPub/Restaurant + FAQPage
 */

export const dynamic = "error";

const PATH = "/saltaire/boathouse-inn";
...
// Images you provided:
// /public/images/saltaire/boathouse/*
const HERO_IMAGE = "/images/saltaire/boathouse/indoor-and-outdoor-view.png";

// Gallery images (exclude hero)
const GALLERY = [
  {
    src: "/images/saltaire/boathouse/boathouse-indoor.png",
    alt: "Bar interior at The Boathouse Inn in Saltaire",
  },
  {
    src: "/images/saltaire/boathouse/chairs.png",
    alt: "Seating area inside The Boathouse Inn",
  },
  {
    src: "/images/saltaire/boathouse/indoor-view.png",
    alt: "Dining area inside The Boathouse Inn",
  },
] as const;
...
const biz = {
  ...
  tagline: "Riverside bar, lounge & food • Saltaire (BD18)",
  shortDesc:
  ...
  categories: ["Pub", "Bar", "Restaurant", "Riverside", "Cask ales", "Dog-friendly"],

  address: "Victoria Rd, Saltaire, BD18 3LA",
  postcode: "BD18 3LA",

  phone: "01274 585 690",
  email: "info@theboathouseinn.co.uk",
  website: "https://theboathouseinn.co.uk/",
  ...
  hoursNote:
    "The website header lists 11:00–21:00. Kitchen/service times can differ, especially around holidays — confirm before a late visit.",
  hours: [
    { day: "Monday", times: "11 am – 9 pm" },
    { day: "Tuesday", times: "11 am – 9 pm" },
    { day: "Wednesday", times: "11 am – 9 pm" },
    { day: "Thursday", times: "11 am – 9 pm" },
    { day: "Friday", times: "11 am – 9 pm" },
    { day: "Saturday", times: "11 am – 9 pm" },
    { day: "Sunday", times: "11 am – 9 pm" },
  ],
  ...
  editorial: {
    bestFor: ["Post-walk food and drinks", "Riverside catch-ups with friends", "Dog-friendly stop in Saltaire"],
    vibe: ["Riverside", "Relaxed", "Modern-comfy", "Local staple"],
    goodToKnow: [
    ...
    bestTime: "Late afternoon into early evening — when the river view is the main event.",
    accessibilityNote:
      "If you need step-free access or extra space (wheelchair/pram), check entrance/route on arrival — older village sites can vary.",
  },

  whatToTry: [
    "Treat it like a proper riverside stop: pick drinks first (cask ale / guest ale / wine) then decide food once you’ve settled.",
    "If you want the view, arrive a bit earlier on weekends to get a good table.",
    "After a wet walk, it’s a reliable warm-up spot — hot drinks and simple comfort food over complicated plans.",
  ],

  ambience: ["River views", "Cask ales", "Pub classics", "Coffee & hot drinks", "Dog-friendly"],

  typicalSpend: "Pub pricing (varies by menu and drinks)",
} as const;
...
export const metadata: Metadata = {
  title: "The Boathouse Inn — Riverside Pub in Saltaire | Saltaire Guide",
  description:
    "The Boathouse Inn in Saltaire (BD18 3LA): address, typical opening hours, contact details, and reviews. Riverside bar, lounge and food on the River Aire.",
  alternates: { canonical: `${site.url}${PATH}` },
  openGraph: {
    title: "The Boathouse Inn — Riverside Pub in Saltaire | Saltaire Guide",
    description:
      "A riverside inn in Saltaire on the River Aire — practical visit info, contact details, typical hours, and reviews.",
    url: `${site.url}${PATH}`,
    type: "article",
    images: [
      {
        ...
        width: 1600,
        height: 1200,
        alt: "The Boathouse Inn indoor and outdoor seating with riverside setting",
      },
    ],
  },
  twitter: {
...
const FAQS = [
  {
    q: "Where is The Boathouse Inn in Saltaire?",
    a: "The Boathouse Inn is on Victoria Road in Saltaire (BD18 3LA), right by the River Aire.",
  },
  {
    q: "What are The Boathouse Inn’s opening hours?",
    a: "The website header lists 11:00–21:00. Food/kitchen times can differ, and hours may change around holidays — confirm before travelling for a specific time.",
  },
  {
    q: "Is The Boathouse Inn dog-friendly?",
    a: "It’s widely treated as dog-friendly. If you want water or a quiet table, ask staff when you arrive.",
  },
  {
    q: "Do I need to book a table?",
    a: "If you’re visiting at peak times (weekends, holidays, evenings), booking is sensible. Use the reservations option on their website.",
  },
] as const;
...
function buildLd() {
  ...
  const webpage = {
    ...
    "@type": "WebPage",
    name: "The Boathouse Inn — Riverside Pub in Saltaire | Saltaire Guide",
    url: `${base}${PATH}`,
  ...
  const breadcrumbs = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "The Boathouse Inn", item: `${base}${PATH}` },
    ],
  };
  ...
  const venue = {
    ...
    address: {
      "@type": "PostalAddress",
      streetAddress: "Victoria Rd",
      addressLocality: "Saltaire",
      addressRegion: "West Yorkshire",
      postalCode: "BD18 3LA",
      addressCountry: "GB",
    },
    sameAs: [biz.website].filter(Boolean),
    url: `${base}${PATH}`,
  ...
  return { webpage, breadcrumbs, venue, faqLd };
}
...
export default function Page() {
  const { webpage, breadcrumbs, venue, faqLd } = buildLd();
                ...
                <Card className="p-0">
                  <div className="p-5">
                    ...
                    <div className="mt-4 rounded-xl border border-stone-200 bg-[#fbf7f1] p-3 text-[12px] text-stone-700">
                      Quick rule: if you’re coming mainly for food, check the current menu/service timing first.
                    </div>
                  </div>
                </Card>
                    ...
                    <div className="mt-4 space-y-3">
                      <div className="rounded-xl border border-stone-200 bg-white p-3">
                        ...
                        <div className="mt-1 text-[13px] leading-relaxed text-stone-800">
                          Riverside Saltaire spot — ideal if you want “walk + pint/food” without extra travel.
                        </div>
                      </div>
